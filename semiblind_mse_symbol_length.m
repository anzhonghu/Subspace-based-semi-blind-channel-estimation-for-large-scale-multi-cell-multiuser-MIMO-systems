...
set(h,'PaperType','A4');
xx = axes('FontSize',16);
semilogy(N_s,cova_store(:,4),'b-.o','MarkerSize',10)
hold on
semilogy(N_s,cova_store(:,1),'k:*')
semilogy(N_s,cova_store(:,2),'k:s','MarkerSize',10)
semilogy(N_s,cova_store(:,3),'k-d','MarkerSize',10)
semilogy(N_s,cova_store(:,5),'r-+')
...
xlabel('Number of data symbols','Fontsize',16,'Fontname','Times')
ylabel('MSE','Fontsize',20,'Fontname','Times')
%print(h,'-dpdf','evd_mse_symbol_length')